...
func LoadConfig(cfg string) *Config {
    ...
    config := &Config{
        WeworkCorpId:               getViperStringValue("CORP_ID", ""),
        WeworkAppId:                getViperIntValue("APP_ID", 0),
        WeworkAppSecret:            getViperStringValue("APP_SECRET", ""),
        WeworkToken:                getViperStringValue("Token", ""),
        WeworkEncodingAESKey:       getViperStringValue("EncodingAESKey", ""),
        ...
        QdrantCollection:           getViperStringValue("QDRANT_COLLECTION", "wework-vkm"),
    }
